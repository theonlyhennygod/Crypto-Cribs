          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Contribute to win amazing prizes
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <input
                ...
                onChange={(e) =>
                  setContributionAmount(Number.parseInt(e.target.value) || 1)
                }
            ...
            <p className="text-xs text-muted-foreground text-center">
              1 ticket per 5 {activeWallet === "metamask" ? "C2FLR" : "XRP"}{" "}
              contributed
            </p>
          </div>
        ) : (
            ...
            {todaysPrizes.map((prize, index) => {
              ...
              return (
                <motion.div
                  ...
                  className={`flex items-center gap-3 p-3 rounded-lg border ${getRarityColor(
                    prize.rarity
                  )}`}
                >
